...
class LongOpenAddressingMapTest extends LongMapTest {
  ...
  void shouldGetNullValue() {
    super.shouldGetNullValue(new LongOpenAddressingMap<>());
  }
  ...
  void shouldReturnNullWhenRemoveValue() {
    super.shouldReturnNullWhenRemoveValue(new LongOpenAddressingMap<>());
  }
  ...
  void shouldReturnNullArrayOfKeys() {
    super.shouldReturnNullArrayOfKeys(new LongOpenAddressingMap<>());
  }
  ...
  void shouldReturnNullArrayOfValues() {
    super.shouldReturnNullArrayOfValues(new LongOpenAddressingMap<>());
  }
  ...
  void shouldWorkAfterRehash() {
    super.shouldWorkAfterRehash(new LongOpenAddressingMap<>());
  }
